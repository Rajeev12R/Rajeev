      ...
      <div className="flex flex-col py-32 mt-10 space-y-10 px-10">
        ...
        <div className="flex justify-between items-start space-x-6">
          ...
          <div className="flex flex-col w-full">
            ...
            <p className="text-neutral-600 text-lg leading-relaxed">
             <strong> Built a modern, responsive marketing agency website</strong> using <strong>React.js</strong> and <strong>Tailwind CSS</strong>, integrating smooth animations using <strong>Framer mation</strong> and an intuitive user interface for an enhanced user experience.
            </p>
            <p className="text-neutral-600 text-lg leading-relaxed">
