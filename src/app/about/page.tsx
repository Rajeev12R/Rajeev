    ...
    <div className="min-h-screen w-full max-w-4xl mx-auto">
      <div className="flex flex-col py-32 md:py-24 lg:py-32 mt-4 md:mt-10 space-y-8 md:space-y-10 px-4 sm:px-6 md:px-10">
        ...
        <p className="font-light text-neutral-600 text-base md:text-lg lg:text-xl leading-relaxed tracking-wide">
          Hello, I&apos;m Rajeev, a full-stack developer from India with
          expertise in the MERN stack, Next.js, and JavaScript. I thrive on
          solving complex problems and building scalable, high-performance
          applications. With a passion for clean code, modern design, and
          continuous learning, I&apos;m always eager to work on innovative
          projects that create a real impact.
        </p>

        {/* Experience Section */}
        <h2 className="font-semibold text-3xl md:text-4xl tracking-tight pt-4">
          Experience
        </h2>
        ...
        <div className="space-y-8 md:space-y-0">
            ...
            <div className="flex flex-col w-full">
              ...
              <div className="space-y-3 md:space-y-4 mt-2">
                <p className="text-neutral-600 text-base md:text-lg leading-relaxed">
                  ...
                  using
                  <strong> React.js, Node.js, MongoDB, and Tailwind CSS</strong>
                  , ensuring <strong>seamless responsiveness</strong>
                  and an <strong>optimal user experience</strong> across
                  devices.
                </p>
                <p className="text-neutral-600 text-base md:text-lg leading-relaxed">
                  Worked closely with clients to design scalable solutions,
                  optimizing{" "}
                  <strong>
                    database efficiency and application performance
                  </strong>{" "}
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:space-x-6 mt-8 md:mt-0">
            ...
            <div className="flex flex-col w-full">
              ...
              <h3 className="font-semibold text-lg md:text-xl">
                Full Stack Developer Intern - Wide Take
              </h3>
              <div className="space-y-3 md:space-y-4 mt-2">
                <p className="text-neutral-600 text-base md:text-lg leading-relaxed">
                  <strong>
                    Built a modern, responsive marketing agency website
                  </strong>{" "}
                  using <strong>React.js</strong> and{" "}
                  <strong>Tailwind CSS</strong>, integrating smooth animations
                  using <strong>Framer Motion</strong> and an intuitive user
                  interface for an enhanced user experience.
                </p>
                <p className="text-neutral-600 text-base md:text-lg leading-relaxed">
                  Enhanced <strong>website performance and SEO</strong>, for
                  faster load times and improved search engine visibility.
                </p>
              </div>
            </div>
          </div>
